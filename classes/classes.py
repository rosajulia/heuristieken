...
#     def calculate_fuel_weight(self, fuel_weight, max_weight):
#         self.fuel_weight = (self.mass + self.max_weight) * self.ftw / (1-self.ftw)
    
#     def calculate_fuel_cost(self):
#         fuel_cost = self.base_cost + fuel_weight * 100 * 5
